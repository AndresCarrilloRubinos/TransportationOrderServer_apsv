...
public class TransportationOrderServerApplication {
    ...
    public static final Logger log =
        LoggerFactory.getLogger(TransportationOrderServerApplication.class);

    private final TransportationOrderRepository torderRepository;

    public TransportationOrderServerApplication(TransportationOrderRepository repo){
        this.torderRepository = repo;
    }
